...
from data.dataset import ClassificationDataset, create_data_loaders
from model.cls_model import BertForClassification, load_model
...
def main():
    ...
    dataset = ClassificationDataset(config.data_path, config.model_path)
